...
⚠️ The STARTER RESOURCES (Readme file, css style and images) was downloaded from its [original source](https://github.com/gitdagray/html_course/tree/main/10_lesson_starter), but the code (project itself) has been written by my own. - Andoti by Lesther XM
